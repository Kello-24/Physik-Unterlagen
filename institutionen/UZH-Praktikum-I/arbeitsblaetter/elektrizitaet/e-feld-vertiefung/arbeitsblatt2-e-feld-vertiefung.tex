...
% Doppellektion (16.09.2026) gehoert -- siehe dort arbeitsblatt3-u-i-r.tex.
...
\begin{center}
\raisebox{-0.5\height}{\includegraphics[width=4cm]{Bilder/electric-peak-field-static.pdf}}
\hspace{0.6cm}
\raisebox{-0.5\height}{\includegraphics[width=4.2cm]{Bilder/lightning-striking-the-eiffel-tower-static.jpg}}
\end{center}
\end{hinweisbox}
\end{theoriebox}
