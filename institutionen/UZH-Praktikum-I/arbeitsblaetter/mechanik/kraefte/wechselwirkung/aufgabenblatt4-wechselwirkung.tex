...
Die schwerere Masse zieht stärker an ihrem Ende der Federwaage als die
leichtere an ihrem, das System setzt sich in Bewegung, statt in Ruhe zu
bleiben. Die Anzeige der Federwaage entspricht dann nicht mehr einfach der
Gewichtskraft einer einzelnen Masse, sondern stellt sich auf einen Wert
zwischen den beiden Gewichtskräften ein. Das ursprüngliche Experiment
funktioniert nur deshalb so einfach, weil beide Massen exakt gleich schwer
sind.
\end{solution}
\end{parts}
\end{taskbox}
